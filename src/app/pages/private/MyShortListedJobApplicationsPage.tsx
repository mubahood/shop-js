  ...
  const fetchApplications = useCallback(
    async (page: number, search: string) => {
      ...
      try {
        ...
        //filter data and only show in status of 'Interview'
        resp.data = resp.data.filter((app) => app.status === "Interview");
            ...
            {!isLoading && !error && apps.length === 0 && (
              <div className="d-flex flex-column align-items-center justify-content-center py-5">
                <Alert variant="info" className="text-center w-50">
                  <h4>No Shortlisted Applications Found</h4>
                  <p className="mb-4">
                    You haven't shortlisted any applications yet.
                  </p>
